  ...
  return (
    <div className={`inline-flex ${!isVariant ? 'rounded-md shadow' : ''}`} {...rest}>
      <button
        type='button'
        className={cn({
          'inline-flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md focus:outline-none focus:shadow-outline transition duration-150 ease-in-out': true,
